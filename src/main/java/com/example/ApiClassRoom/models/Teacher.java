...
public class Teacher {
    ...
    @ManyToOne(fetch = FetchType.LAZY)  // Muchos docentes pueden asociarse a un usuario, o si es 1 a 1, usar @OneToOne
    @JoinColumn(name = "user_id", nullable = false)
    @JsonBackReference  // para evitar ciclos en JSON (marca el lado "hijo")
    private User user;
